...
@flask_app.route('/')
def home(): return "ZEVRIC PROFESSIONAL ₹130 AUTO-DELETE OFF ❌"
def run_flask():
...
❌ Auto-Delete: OFF - Sab messages rahenge ✅
...
async def main():
    while True:
        try:
            ...
            print("BOT LIVE AUTO-DELETE OFF ❌ ₹130")
