...
❓ Kaise Use Kare:
1️⃣ /addbalance - UPI se payment karo
2️⃣ Screenshot + UTR bhejo
3️⃣ /buycredits se credit kharido
4️⃣ /myguilds me guild ID set karo
5️⃣ /launch se bot launch karo

💳 Payment Help:
• UPI: `{UPI_ID}`
• USDT: `{USDT_ADDR}`
• 1 Screenshot + 1 UTR bhejna zaruri

📞 Support:
• Admin: @{SUPPORT}
• Payment issue? Screenshot ke sath contact karo
"""
